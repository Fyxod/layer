...
| --- | --- | --- | --- | --- | --- | --- |
| unet.conv_in | add black sunglasses | 4.0000 | 0 | 0 | 0.9995 | 0 |
| unet.conv_in | add headphones | 4.0000 | 0 | 0 | 0.9995 | 0 |

## Per-run final values

| validity | layer | prompt | image | dZ | input SSIM | output SSIM | max disp |
| --- | --- | --- | --- | --- | --- | --- | --- |
| valid_or_visually_check | unet.conv_in | add black sunglasses | barack_obama_01 | 0 | 0.9993 | 0.9985 | 0.3955 |
| valid_or_visually_check | unet.conv_in | add black sunglasses | joe_biden_01 | 0 | 0.9995 | 0.9988 | 0.3955 |
| valid_or_visually_check | unet.conv_in | add black sunglasses | kamala_harris_01 | 0 | 0.9997 | 0.9992 | 0.3955 |
| valid_or_visually_check | unet.conv_in | add black sunglasses | michelle_obama_01 | 0 | 0.9993 | 0.9986 | 0.3955 |
| valid_or_visually_check | unet.conv_in | add headphones | barack_obama_01 | 0 | 0.9993 | 0.9755 | 0.3955 |
| valid_or_visually_check | unet.conv_in | add headphones | joe_biden_01 | 0 | 0.9995 | 0.9975 | 0.3955 |
| valid_or_visually_check | unet.conv_in | add headphones | kamala_harris_01 | 0 | 0.9997 | 0.9988 | 0.3955 |
| valid_or_visually_check | unet.conv_in | add headphones | michelle_obama_01 | 0 | 0.9993 | 0.9946 | 0.3955 |
